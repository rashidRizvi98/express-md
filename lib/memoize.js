 ...
 * @param {function} fn - function to memorise
 * @param {function} cache - cache object to use
 * @param {string} hashPrefix - cache key prefix
 * @returns {function} instance of the function
 */
